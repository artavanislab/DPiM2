...
public:
  ...
  vector< vector<double> > searchByPrey; // sbp["search_id"]["prey"] = tsc
  // where "search_id" is the map from search_id to index in 
  ...
  void dumpSBP(string outFile); // dump main matrix
