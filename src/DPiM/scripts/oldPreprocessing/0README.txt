...
UTIL - points to the directory containing qsubWrap.pl
...
UTIL="/home/glocke/DPiM/scripts/"; export UTIL;
...
The perl expects apms data in tsv columns: 
search_id       bait_ref        prey_ref        total_peptides  sample_date     ms_inst_run_id

There may be comments in the file (first character in line being '#'), and the
first non-commented line must name the columns.
