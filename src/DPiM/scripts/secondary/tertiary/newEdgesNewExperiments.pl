...
# find the marginal number of edges found in each experiment
#   marginal meaning number of edges never before seen

# first read in the final network
# sort experiments by run id
# for each experiment:
#  * find all discoverable edges in each experiment
#  * find which of them are in the final network
